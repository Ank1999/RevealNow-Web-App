...
export const EssentialIconsSend2 = ({ className }) => {
  return (
    <svg
      className={`essential-icons-send-2 ${className}`}
      fill="none"
      height="18"
      viewBox="0 0 18 18"
      width="18"
    ...
    >
      <g className="g" clipPath="url(#clip0_211_1021)">
        <path
          className="path"
          clipRule="evenodd"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_211_1021">
